...
function popUps() {
    ...
    let date = document.querySelector(`#time2`)
    let date1 = document.querySelector(`.cl3`)
    let date2 = document.querySelector(`.cl4`)
   ...
   let classbt = document.querySelector(`#class-bt`)
